...
public class GUI{
  ...
  public GUI() {
    ...
    // final JTextArea textInput = new JTextArea(1,30);
    // textInput.setRows(1);
  ...
  private void loadFiles()
  {
    try {
      ...
      System.err.println("Warning: Could not open file kitchenPorch.png");
    } 

    try {
      dogImage = ImageIO.read(new File("dog.png"));      
    } catch (Exception e) {
      System.err.println("Warning: Could not open file dog.png");
    } 

    try {
      dogEatImage = ImageIO.read(new File("dogEat.png"));      
    } catch (Exception e) {
      System.err.println("Warning: Could not open file dogEat.png");
    } 

    try {
      dogSpeakImage = ImageIO.read(new File("dogSpeak.png"));      
    } catch (Exception e) {
      System.err.println("Warning: Could not open file dogSpeak.png");
    } 

    try {
      dogSitImage = ImageIO.read(new File("dogSit.png"));      
    } catch (Exception e) {
      System.err.println("Warning: Could not open file dogSit.png");
    } 

    try {
      dogWalkImage = ImageIO.read(new File("dogWalk.png"));      
    } catch (Exception e) {
      System.err.println("Warning: Could not open file dogWalk.png");
    } 
  }
}